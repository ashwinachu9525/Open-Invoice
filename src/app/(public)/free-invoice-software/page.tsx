...
export const metadata: Metadata = {
  title: "Free Invoice Software for Small Businesses | InvoiceAI",
  description: "Create professional invoices, send estimates, and track payments with our 100% free online invoicing software designed for small businesses and freelancers.",
}
    ...
    <div className="bg-white text-slate-900 font-sans selection:bg-blue-500/30">
      ...
      <section className="relative pt-24 pb-20 lg:pt-32 lg:pb-28 overflow-hidden bg-slate-50 border-b border-slate-200">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          <h1 className="text-5xl lg:text-7xl font-extrabold tracking-tight mb-8 leading-[1.1] text-slate-900">
            Free Online Invoicing Software <br className="hidden lg:block" />
          ...
          <p className="text-lg lg:text-xl text-slate-600 max-w-2xl mx-auto mb-10 leading-relaxed">
            Create professional invoices, send estimates, and get paid faster. 
          ...
          <div className="mt-12 pt-8 flex flex-wrap justify-center gap-8 text-sm text-slate-600 font-medium">
            ...
            <div className="flex items-center gap-2"><CheckCircle2 className="w-5 h-5 text-green-500" /> Unlimited Invoices</div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold mb-3 text-slate-900">Professional Invoices</h3>
              <p className="text-slate-600">
                Create beautiful, customizable PDF invoices in seconds. Upload your logo and set your brand colors to stand out.
              </p>
            </div>
      ...
      <section className="py-24 bg-blue-600 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <h2 className="text-4xl font-extrabold text-white mb-6">Ready to upgrade your invoicing?</h2>
          <p className="text-xl text-blue-100 mb-10">
            Join thousands of small businesses that trust us to manage their billing. It takes less than a minute to get started.
          </p>
          <Link 
            href="/register" 
