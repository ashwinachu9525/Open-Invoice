    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-sm border p-8 md:p-12">
        ...
        <div className="prose prose-blue max-w-none text-gray-600 space-y-6">
          <p>
            This is the official Privacy Policy for Open Invoice. We are currently updating our detailed legal documentation. 
            Please check back soon for the full text of our Privacy Policy.
          </p>
          <p>
            If you have any immediate concerns regarding our Privacy Policy, please contact our legal or support team through the Contact Us page.
          </p>
        </div>
