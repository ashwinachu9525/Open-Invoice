...
export function BankAccountsForm({ initialAccounts }: BankAccountsFormProps) {
    ...
    <div className="space-y-6">
      {accounts.length === 0 && !isAdding ? (
        <div className="text-center py-8 glass glass-card border-white/10 rounded-xl">
          ...
          <Button onClick={() => setIsAdding(true)} variant="outline" className="mt-4 glass border-white/10">
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center mb-4">
            ...
            {!isAdding && (
              <Button onClick={() => setIsAdding(true)} size="sm" variant="outline" className="glass border-white/10">
